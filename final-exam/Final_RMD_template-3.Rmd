...
# Assuming progresa_full is your dataset
progresa_full$treat <- ifelse(progresa_full$treatment == 1, 1, 0)
progresa_full$post <- ifelse(progresa_full$year == 1999, 1, 0)
progresa_full$interaction <- progresa_full$treat * progresa_full$post

## Run the OLS regression w/dummies
# OLS regression
model <- lm(vani ~ treat + post + interaction, data = progresa_full)
